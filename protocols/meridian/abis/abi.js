export default [
  ...
  { anonymous: false, inputs: [], name: "FlashLoansPaused", type: "event" },
  { anonymous: false, inputs: [], name: "FlashLoansUnpaused", type: "event" },
  {
    anonymous: false,
    inputs: [
      {
